...
class ADDLoss(nn.Module):
    ...
    def forward(self, pred_R, pred_T, gt_R, gt_T, model_points, is_symmetric=False):
        """
        ...
        is_symmetric: bool -> Se True, usa ADD-S, altrimenti ADD
        """
        ...
        if not is_symmetric:
            ...
            # --- ADD-S (Oggetti simmetrici) ---
            # Distanza media dal punto più vicino (indipendente dall'orientamento specifico)
            # torch.cdist calcola tutte le distanze tra le due nuvole di punti
